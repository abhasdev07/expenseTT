...
class TransactionSchema(Schema):
    ...
    recurring_frequency = fields.Str(validate=validate.OneOf(['daily', 'weekly', 'monthly', 'yearly']))
    recurring_end_date = fields.DateTime(allow_none=True)
    created_at = fields.DateTime(dump_only=True)
    updated_at = fields.DateTime(dump_only=True)
...
class InsightSchema(Schema):
    ...
    title = fields.Str()
    message = fields.Str()
    severity = fields.Str(validate=validate.OneOf(['info', 'warning', 'success', 'error']))
    data = fields.Dict()
